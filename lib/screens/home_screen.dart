        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(color: LvsColors.pink.withOpacity(0.1), blurRadius: 10),
                BoxShadow(color: LvsColors.violet.withOpacity(0.1), blurRadius: 10, offset: const Offset(5, 5)),
              ]
            ),
            child: ShaderMask(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      shape: BoxShape.circle,
                      boxShadow: [
                        BoxShadow(color: LvsColors.red.withOpacity(0.15),   blurRadius: 60, spreadRadius: 5, offset: const Offset(-20, 0)),
                        BoxShadow(color: LvsColors.pink.withOpacity(0.15), blurRadius: 60, spreadRadius: 5, offset: const Offset(-10, 0)),
                        BoxShadow(color: LvsColors.violet.withOpacity(0.15), blurRadius: 60, spreadRadius: 5, offset: const Offset(20, 0)),
                      ]
                    ),
                  ),
            ...
            children: [
              ...
              SliderTheme(
                data: SliderTheme.of(context).copyWith(
                  ...
                  thumbColor: Colors.white, overlayColor: LvsColors.amber.withOpacity(0.2),
              ...
              SliderTheme(
                data: SliderTheme.of(context).copyWith(
                  ...
                  thumbColor: Colors.white, overlayColor: LvsColors.pink.withOpacity(0.2),
                  thumbShape: const RoundSliderThumbShape(enabledThumbRadius: 12),
                ),
                child: Slider(
              ...
              SliderTheme(
                data: SliderTheme.of(context).copyWith(
                  ...
                  thumbColor: Colors.white, overlayColor: LvsColors.teal.withOpacity(0.2),
                  thumbShape: const RoundSliderThumbShape(enabledThumbRadius: 12),
                ),
                child: Slider(
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: active ? [BoxShadow(color: color.withOpacity(0.15), blurRadius: 12)] : [],
        ),
        child: Column(
          children: [
